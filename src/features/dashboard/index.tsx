...
import {
  ...
  selectHighestStudents,
  selectLowestStudents,
...
export default function Dashboard() {
  ...
  const highestStudentList = useAppSelector(selectHighestStudents);
  const lowestStudentList = useAppSelector(selectLowestStudents);
