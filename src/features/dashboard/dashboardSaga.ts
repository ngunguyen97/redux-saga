...
function* fetchHighestStudentList() {
  ...
  yield put(dashboardActions.setHighestStudents(data));
}
...
function* fetchLowestStudentList() {
  ...
  yield put(dashboardActions.setLowestStudents(data));
}
...
export default function* dashboardSaga() {
  console.log('dashboardSagaActions: ', dashboardActions.fetchData.type);
